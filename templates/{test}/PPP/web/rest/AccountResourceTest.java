...
import <%=project.package%>.domain.Authority;
import <%=project.package%>.domain.User;
import <%=project.package%>.repository.AuthorityRepository;
import <%=project.package%>.repository.UserRepository;
import <%=project.package%>.security.AuthoritiesConstants;
import <%=project.package%>.service.MailService;
import <%=project.package%>.service.UserService;
import <%=project.package%>.web.rest.dto.UserDTO;
