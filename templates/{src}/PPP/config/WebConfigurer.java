...
import <%=project.package%>.web.filter.CachingHttpHeadersFilter;
import <%=project.package%>.web.filter.StaticResourcesProductionFilter;
import <%=project.package%>.web.filter.gzip.GZipServletFilter;
