package <%=project.package%>.config.oauth2;

import <%=project.package%>.domain.OAuth2AuthenticationAccessToken;
import <%=project.package%>.domain.OAuth2AuthenticationRefreshToken;
